...
public class DbSeeder
{
    ...
    public async Task SeedingUnitOfMeasures()
    {
        ...
        var predefinedUnits = new List<string> { "Piece", "Item", "Box", "Carton", "Kg", "Liter", "Meter", "Roll" };
    ...
    public async Task SeedingMaterials()
    {
        ...
        var faker = new Faker<Material>()
            ...
            .RuleFor(m => m.CategoryId, f => f.PickRandom(categoryIds).ToString()) 
            .RuleFor(m => m.UnitOfMeasureId, f => f.PickRandom(unitIds).ToString()) 
