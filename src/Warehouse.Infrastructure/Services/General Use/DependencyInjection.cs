...
using Warehouse.Infrastructure.Services.Document;
...
namespace Warehouse.Infrastructure.Services
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddInfrastructure (this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IDocumentManageService, DocumentManageService>();
            services.AddScoped<IWarehouseDetailService, WarehouseDetailService>();
            services.AddScoped<IValidatorName, ValidatorName>();
