        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitOfMeasureId1 = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Materials_MaterialCategories_CategoryId1",
                        column: x => x.CategoryId1,
                        principalSchema: "warehouse",
                        principalTable: "MaterialCategories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Materials_UnitOfMeasures_UnitOfMeasureId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Materials_UnitOfMeasureId1",
                schema: "warehouse",
                table: "Materials",
